...
var FirestoreService = /** @class */ (function () {
    ...
    function FirestoreService(database) {
        ...
        this.usuariosColletion = this.database.collection('usuarios');
    }
    FirestoreService.prototype.agregarDatos = function (id, edad, sexo, altura, peso) {
        var _this = this;
    ...
    FirestoreService.prototype.agregarUsuario = function (usuario, id) {
        var _this = this;
        //RESOLVE: promesa resulta -> similar al then
        //REJECT: promesa rechazada -> similar al catch
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var resultado, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        usuario.uid = id;
                        return [4 /*yield*/, this.usuariosColletion.doc(id).set(usuario)];
                    case 1:
                        resultado = _a.sent();
                        //muestra el resultado sin problema
                        resolve(resultado);
