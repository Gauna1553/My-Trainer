...
var routes = [
    ...
    },
    {
        ...
        canActivate: [roles_guard_1.RoleGuard], data: { expect: roles_1.Roles.Visitante } //ruta de visitante
    },
    { path: '', loadChildren: function () { return Promise.resolve().then(function () { return require('./modules/admin/admin.module'); }).then(function (m) { return m.AdminModule; }); }, canActivate: [roles_guard_1.RoleGuard], data: { expect: roles_1.Roles.Admin } }, {
        path: '',
        loadChildren: function () { return Promise.resolve().then(function () { return require('./modules/concepinf/concepinf.module'); }).then(function (m) { return m.ConcepinfModule; }); }
    }, {
        path: '',
